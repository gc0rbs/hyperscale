...
| Check a season's numbers | [Season parameters](reference/season-parameters.md) |
...
| What decides your share | Your rig's hashrate × the seconds it mines in each block × that block's fixed pay rate |
| What other players change | The pace: more hashrate finds blocks sooner and ends the season sooner |
| Randomness | None |
| Admin power over a live season | Pause only. No parameter changes, no upgrades to the contracts, no minting |
| How it ends | Block 4 found, or the cap. Stakes return, fragments redeem for 30 days |
