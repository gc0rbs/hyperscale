...
export const ROUND_NOTICES = [
  "Pots are funded by the creator fee on every $VRAM trade on Pons, swapped into Stock Tokens and added to the running round as fees arrive. A round with no fees pays only what rolled over.",
