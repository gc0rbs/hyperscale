export const metadata = { title: "Stock Miner · Not available in your region" };
  ...
  return (
    <main className="min-h-screen bg-mine-bg text-mine-fg px-6 py-24 flex flex-col items-center text-center gap-6">
      ...
      <p className="text-mine-muted text-[16px] max-w-[560px]">
        Stock Miner pays out Robinhood Stock Tokens, which are not available to persons in the United States, Canada, the United Kingdom or Switzerland. This site is not offered in your region.
      </p>
