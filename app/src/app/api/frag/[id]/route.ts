...
export async function GET(_req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json({
    ...
    description: `1/${fragPerToken.toLocaleString("en-US")} of one ${ticker} Stock Token, earned as a shard in Hyperscaler. Non-transferable; redeem at the game's vault.`,
    decimals: 0,
