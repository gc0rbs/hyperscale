...
export const metadata = { title: "Stock Miner · Terms" };
...
export default function Terms() {
  return (
    <main className="min-h-screen bg-mine-bg text-mine-fg px-4 md:px-8 py-16 max-w-[820px] mx-auto text-[15px] leading-[1.65] text-mine-muted">
      ...
      <H>7. Stock Tokens</H>
      <p>Robinhood Stock Tokens are tokenized instruments that track the price of an underlying security. They confer no ownership, voting or dividend rights in the underlying company. Their availability and transferability are determined by their issuer, not by Stock Miner.</p>
